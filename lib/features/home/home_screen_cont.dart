...
Future<List<DocumentSnapshot>> getUserEvents() async {
  QuerySnapshot eventSnapshot = await FirebaseFirestore.instance
      .collection('events')
      .where('type', isEqualTo: 'public')
      .get();

  List<DocumentSnapshot> futureEvents = eventSnapshot.docs.where((doc) {
  ...
  children: [
    ...
    Positioned(
      ...
      child: Container(
        ...
        child: Text(
          DateFormat('dd/MM').format(snapshot.data?[index]['start_date'].toDate()),
        ...
        child: Row(
          ...
          children: [
            Column(
              ...
              children: [
                SizedBox(height: 10),
                Text('Get Your Subscription Today!', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
            ...
            Icon(
              Icons.event_available, // replace with your desired icon
              size: 70, // adjust as needed
              color: Colors.white10, // adjust color as needed
            ),
          ],
        ),
      ),
